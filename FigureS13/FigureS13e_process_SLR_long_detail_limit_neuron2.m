...
----------------------------------------------------------------------------
%}
function FigureS13e_process_SLR_long_detail_limit_neuron2(folders)
...
make_psychometric_function(analysis_dir,SLR_choice, use_frame, thre_neuron);


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function make_psychometric_function(analysis_dir,SLR_name, use_frame, thre_neuron)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for j = 1:size_frame
    ...
    figure;hold on
    plot_mean_se_moto_x_axis(temp_R,evi_x,[1 0 0],2)
    plot_mean_se_moto_x_axis(temp_L,evi_x,[0 0 1],2)
