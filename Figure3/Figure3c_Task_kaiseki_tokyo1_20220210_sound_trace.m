...
----------------------------------------------------------------------------
%}
function Figure3c_Task_kaiseki_tokyo1_20220210_sound_trace

%data = a04_20210316_spike341
close all
Fig ='3';% mpfc:3

id =341;% spike id
directry = 'G:\Ishizu_data\Tokyo_ephys_ishizu\mpfc\a04\2021-03-16_a04_mPFC_Left_OK\recording1_task';
cd(directry);
