...
----------------------------------------------------------------------------
%}
function Figure3e_Task_kaiseki_tokyo1_20220215_prior_trace

close all
id =365;% spike id
Fig ='3';% mpfc:3 / auc:4 / fof:S8
directry = 'G:\Ishizu_data\Tokyo_ephys_ishizu\mpfc\a04\2021-03-15_a04_mPFC_Left_OK\recording1_task';
cd(directry);
...
%% Fig e top
cd('G:\upload_code\Figure3\Fig3e');
