...
% for j=1:es
    ...
    xlabel('trail');
    ylabel('correct rate');     
    sdata.trial_id = xTrial';
    sdata.whole_large_previous = p_pref;
    sdata.whole_small_previous = p_npref;
    sdata.whole_large_previous_upper = err1_pref;
    sdata.whole_large_previous_lower = err2_pref;
    sdata.whole_small_previous_upper = err1_npref;
    sdata.whole_small_previous_lower = err2_npref;
    ...
    xlabel('trail');
    ylabel('correct rate');
    sdata.long_large_previous = p_pref;
    sdata.long_small_previous = p_npref;
    sdata.long_large_previous_upper = err1_pref;
    sdata.long_large_previous_lower = err2_pref;
    sdata.long_small_previous_upper = err1_npref;
    sdata.long_small_previous_lower = err2_npref;
    ...
    xlabel('trail');
    ylabel('correct rate');
    sdata.short_large_previous = p_pref;
    sdata.short_small_previous = p_npref;
    sdata.short_large_previous_upper = err1_pref;
    sdata.short_large_previous_lower = err2_pref;
    sdata.short_small_previous_upper = err1_npref;
    sdata.short_small_previous_lower = err2_npref;
...
cd('G:\upload_code\FigureS1\FigS1b');

T = struct2table(sdata);
writetable(T, 'source figS1b.csv');
end
