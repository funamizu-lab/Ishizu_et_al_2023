...
%%% FigS1e
cd('G:\upload_code\FigureS1\FigS1ef');
...
sdata.data1=plot_log_likeli(:,1);
sdata.data2=plot_log_likeli(:,2);
sdata.data3=plot_log_likeli(:,3);
T = struct2table(sdata);
writetable(T, 'source fig S1e left.csv');
...
sdata.data=plot_log_likeli(:,4);
T = struct2table(sdata);
writetable(T, 'source fig S1e right.csv');
...
sdata = struct();% source data 
output=compare_parameters_RL([6,5],para_max_all,N_para,all_subject); %short long
sdata.data1=output(:,1);
sdata.data2=output(:,2);
T = struct2table(sdata);
writetable(T, 'source fig S1f.csv');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function output=compare_parameters_RL(use_para,para_max_all,N_para,all_subject)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
