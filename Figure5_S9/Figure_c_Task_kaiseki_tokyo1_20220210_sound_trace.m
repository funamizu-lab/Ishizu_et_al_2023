...
if(flag==1)
    Fig ='5';
    id =338;% spike id
    directry = 'G:\Ishizu_data\IntermediateFiles\auditory\i24\2021-10-06_i24_AC_left_OK\recording1_task';
elseif(flag==2)
    Fig ='S9';% auc:5 / fof:S9
    id =526;% spike id
    directry = 'G:\Ishizu_data\IntermediateFiles\fof\i24\2021-10-01_i24_FOF_left_OK\recording1_task';
end
