...
if(flag==1)
    Fig ='5';
    id =278;% spike id
    directory = 'G:\Ishizu_data\IntermediateFiles\auditory\i34\2021-11-17_i34_AC_left_OK\recording2_task';
elseif(flag==2)
    Fig ='S9';% auc:5 / fof:S9
    id =260;% spike id
    directory = 'G:\Ishizu_data\IntermediateFiles\fof\a04\2021-02-27_a04_FOF_Right_chunkerror_OK\recording1_task';
end
cd(directory)
