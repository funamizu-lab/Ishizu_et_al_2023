...
----------------------------------------------------------------------------
%}
function Figure_h_process_20220516_simple_process_test5_depth_control(folders)
...
%% fig h
cd('G:\upload_code\Figure5_S9\h');
region_num={'5','S9'};
name = cell2mat(region_num(ismember({'auc','fof'},extractBefore(folders,'_'))));
...
writetable(T, ['source fig',name,'h.csv']);
