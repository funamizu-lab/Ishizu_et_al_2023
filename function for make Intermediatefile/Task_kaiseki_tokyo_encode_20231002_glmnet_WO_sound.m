...
----------------------------------------------------------------------------
%}
function Task_kaiseki_tokyo_encode_20231002_glmnet_WO_sound(pathname)
...
% eval(temp_cd);
cd(spike_dir)
mkdir('KernelEncoding_20231002_WO_sound');

%save KernelEncoding_20220320/KernelEncoding_20220320_kernel kernel_all kernel_size_y moto_frame5 CV_para
save KernelEncoding_20231002_WO_sound/KernelEncoding_20231002_kernel_WO_sound kernel_all kernel_size_y CV_para moto_frame_sound
...
%for file_count = 1:max_tif
    ...
    save_file = sprintf('KernelEncoding_20231002_WO_sound/KernelEncoding_20231002_glmnet_WO_sound_%d',file_count);
