...
----------------------------------------------------------------------------
%}
function Task_kaiseki_tokyo1_20220218_ishizu(folders)
...
for i = 1:length(analysis_dir)
    ...
    [p_task_long_p,p_task2_long_p] = get_p_values_task_activ(use_long,frame_sound,frame_choice_select,frame_spout,max_tif,...
        time_long_pre,time_long_post,time_long_pre2,time_long_post2,time_window,time_window_base,1);
    
    [p_task_short_p,p_task2_short_p] = get_p_values_task_activ(use_short,frame_sound,frame_choice_select,frame_spout,max_tif,...
        time_short_pre,time_short_post,time_short_pre2,time_short_post2,time_window,time_window_base,1);
    
    [p_task_long_n,p_task2_long_n] = get_p_values_task_activ(use_long,frame_sound,frame_choice_select,frame_spout,max_tif,...
        time_long_pre,time_long_post,time_long_pre2,time_long_post2,time_window,time_window_base,2);
    
    [p_task_short_n,p_task2_short_n] = get_p_values_task_activ(use_short,frame_sound,frame_choice_select,frame_spout,max_tif,...
        time_short_pre,time_short_post,time_short_pre2,time_short_post2,time_window,time_window_base,2);
    
    cd(pathname)
    
    save sig3_task_neurons_20220218 p_task_long_p p_task2_long_p p_task_short_p p_task2_short_p p_task_long_n p_task2_long_n p_task_short_n p_task2_short_n
end
