...
----------------------------------------------------------------------------
%}
function Task_kaiseki_tokyo_encode_20220912_glmnet_WO_prior(pathname)
...
% eval(temp_cd);
cd(spike_dir)
mkdir('KernelEncoding_20220912_WO_prior');

%save KernelEncoding_20220320/KernelEncoding_20220320_kernel kernel_all kernel_size_y moto_frame5 CV_para
save KernelEncoding_20220912_WO_prior/KernelEncoding_20220912_kernel_WO_prior kernel_all kernel_size_y CV_para moto_frame_sound
...
%for file_count = 1:max_tif
    ...
    save_file = sprintf('KernelEncoding_20220912_WO_prior/KernelEncoding_20220912_glmnet_WO_prior_%d',file_count);
