...
----------------------------------------------------------------------------
%}
function Task_kaiseki_tokyo_encode_20220912_glmnet_process(pathname)
...
folder = '\KernelEncoding_20220912';
folder_sound = '\KernelEncoding_20220912_WO_sound';
folder_choice = '\KernelEncoding_20220912_WO_choice';
folder_prior = '\KernelEncoding_20220912_WO_prior';
...
cd(pathname)
save glmnet_20220912_process BIC part_LL parameter_size parameter_sound parameter_choice parameter_prior ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tif_name = dir('KernelEncoding_20220912_glmnet_*.mat'); %get all the tif files
max_tif = length(tif_name);
temp = dir('KernelEncoding_20220912_kernel*'); %get all the tif files
if length(temp) ~= 1
    temp
    hoge
end
