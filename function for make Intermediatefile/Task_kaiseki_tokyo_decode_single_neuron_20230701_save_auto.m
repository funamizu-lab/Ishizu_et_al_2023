...
----------------------------------------------------------------------------
%}
function Task_kaiseki_tokyo_decode_single_neuron_20230701_save_auto(folders)
...
for i = 1:length(analysis_dir)
    ...
    [long_sound_ROC1,long_choice_ROC1,long_prior_ROC1, ...
        ...
        ROC_task_activ_separate(use_long,frame_sound,frame_choice_select,frame_spout,max_tif,...
    ...
    [short_sound_ROC1,short_choice_ROC1,short_prior_ROC1, ...
        ...
        ROC_task_activ_separate(use_short,frame_sound,frame_choice_select,frame_spout,max_tif,...
        time_short_pre,time_short_post,time_short_pre2,time_short_post2,time_window,time_window_base, ...
        Correct_side, Chosen_side, correct_error, all_binary_prior);
    
    cd(pathname)
    
    save ROC_20230701_long_short ...
        long_sound_ROC1 long_choice_ROC1 long_prior_ROC1 ...
        long_sound_ROC2 long_choice_ROC2 long_prior_ROC2 ...
        short_sound_ROC1 short_choice_ROC1 short_prior_ROC1 ...
        short_sound_ROC2 short_choice_ROC2 short_prior_ROC2
