...
----------------------------------------------------------------------------
%}
function Task_kaiseki_tokyo_encode_20220912_glmnet_WO_choice(pathname)
...
frame5_sound_category_long = get_frame_choice_kernel(lowL, highL, frame_sound5, frame5_time, Time_stretch, -200, 1500);
frame5_sound_category_short = get_frame_choice_kernel(lowS, highS, frame_sound5, frame5_time, Time_stretch, -200, 700);
...
% eval(temp_cd);
cd(spike_dir)
mkdir('KernelEncoding_20220912_WO_choice');

%save KernelEncoding_20220320/KernelEncoding_20220320_kernel kernel_all kernel_size_y moto_frame5 CV_para
save KernelEncoding_20220912_WO_choice/KernelEncoding_20220912_kernel_WO_choice kernel_all kernel_size_y CV_para
...
%for file_count = 1:max_tif
    ...
    save_file = sprintf('KernelEncoding_20220912_WO_choice/KernelEncoding_20220912_glmnet_WO_choice_%d',file_count);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function frame5_choice_long = get_frame_choice_kernel(leftL, rightL, frame_sound5, frame5_time, Time_stretch, pre_sound, post_sound)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
