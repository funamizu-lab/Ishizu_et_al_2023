...
function Dual_RL_model_block1_20220314_para_search_all
clear all
...
%         para_max(filecount).matrix,N_trial(filecount,1)] = Dual_RL_model_block1_20220118_para_search(fpath);
    [ave_likeli,BIC,log_likeli,para_max,N_trial] = Dual_RL_model_block1_20220314_para_search(fpath);
    
    save_file = ['RL_20220314_confidence2_',temp_filename];
