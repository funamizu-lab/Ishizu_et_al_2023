...
----------------------------------------------------------------------------
%}
function Figure5b_Task_20231002_encoding_model_raw(pathname)
...
cd('G:\upload_code\Figure5\Fig5b');
figure; hold on
...
writetable(T, 'source fig5a right.csv');
...
T = struct2table(sdata);
writetable(T, 'source fig5b left.csv');
cd(pathname)