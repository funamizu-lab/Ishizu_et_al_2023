...
----------------------------------------------------------------------------
%}
function FigureS14e_process_SLR_limit_neuron_depth_control(folders)
...
get_correct_plot_20220520(correct_l_choice,name);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function get_correct_plot_20220520(correct_l_choice,name)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
use_frame = 1:3;
...
writetable(T, ['source figS14e left ',name,'.csv']);
