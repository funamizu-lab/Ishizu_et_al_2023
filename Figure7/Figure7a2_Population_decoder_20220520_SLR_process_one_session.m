...
----------------------------------------------------------------------------
%}
function Figure7a2_Population_decoder_20220520_SLR_process_one_session

close all
pathname='G:\Ishizu_data\Tokyo_ephys_ishizu\fof\i24\2021-08-03_i24_FOF_Right_OK\recording2_task';
cd(pathname)
...
%% for choice decording / Fig7a middle
...
writetable(T, 'source fig 7a middle.csv');
