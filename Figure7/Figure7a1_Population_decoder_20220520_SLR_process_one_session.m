...
----------------------------------------------------------------------------
%}
function Figure7a1_Population_decoder_20220520_SLR_process_one_session

close all
pathname='G:\Ishizu_data\Tokyo_ephys_ishizu\auditory\i24\2021-10-08_i24_AC_left_OK\recording2_task';
cd(pathname)
...
writetable(T, 'source fig 7a top.csv');
