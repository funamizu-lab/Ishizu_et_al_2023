function FigureS3d_NeuralSequenceTest
parent='G:/Ishizu_data';
dataPath='/Revise_ishizu/output/SpikeTrace_longtone';
outPath='/Revise_ishizu/output/NeuralSequenceTest';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function CompareSequence(savemat, shuffNum, savefolder, figname1, figname2, figsaveTYPE)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cd(savefolder);
...
for i=1:length(sigid)
    ...
    grand_average_data{i} = mean(spike_trace,1);
    for n=1:shuffNum
        tmp=setdiff(1:trialNum,shuffTrial{n});
        randomshuff_average{i,n} = mean(spike_trace(shuffTrial{n},:),1);
        randomshuff_average_remain{i,n} = mean(spike_trace(tmp,:),1);
    end
end
