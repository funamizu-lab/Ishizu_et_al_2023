...
%% Figure 1c
cd('G:\upload_code\Figure1\Fig1c');
...
set(gca,'xlim',[-0.1 1.1], 'ylim',[0 1])
sdata1.x=evi_x';
sdata1.mouse = mouse_min_L';
T = struct2table(sdata1);
writetable(T, 'source fig1c short leftblock.csv');
sdata2.x=evi_x';
sdata2.mouse = mouse_min_R';
T = struct2table(sdata2);
writetable(T, 'source fig1c short rightblock.csv');
...
set(gca,'xlim',[-0.1 1.1], 'ylim',[0 1])
sdata1.x=evi_x';
sdata1.mouse = mouse_max_L';
T = struct2table(sdata1);
writetable(T, 'source fig1c long leftblock.csv');
sdata2.x=evi_x';
sdata2.mouse = mouse_max_R';
T = struct2table(sdata2);
writetable(T, 'source fig1c long rightblock.csv');
...
sdata.x=evi_x';
sdata.short_left=min_L';
sdata.short_right=min_R';
sdata.long_left=max_L';
sdata.long_right=max_R';
T = struct2table(sdata);
writetable(T, 'source fig1c grand average.csv');
