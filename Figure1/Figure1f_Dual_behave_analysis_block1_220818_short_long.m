...
[ls_mean,~,ls_se]=pplot_mean_se_moto_x_axis(left_minD2,temp_x,[1 0 1],2);
[rl_mean,~,rl_se]=pplot_mean_se_moto_x_axis(right_maxD2,temp_x,[108 173 119]./255,2);
[ll_mean,~,ll_se]=pplot_mean_se_moto_x_axis(left_maxD2,temp_x,[108 173 119]./255,2);
...
%%% fig 1f left %%%
figure; hold on
plot_mean_se_moto_x_axis(dif_right,temp_x,[1 0 0],2)
plot_mean_se_moto_x_axis(dif_left,temp_x,[0 0 1],2)
plot_mean_se_moto_x_axis(easy_right,temp_x,[1 0 1],2)
plot_mean_se_moto_x_axis(easy_left,temp_x,[0 0.5 1],2)
set(gca,'xlim',[-0.1 1.1],'ylim',[0 1])
