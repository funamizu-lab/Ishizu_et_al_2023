...
function Figure6cd_process_20231002_encoding_model_compare_depth_control

close all
[auc_sound,auc_choice,auc_prior, auc_prob, auc_neuron] = process_20231002_encoding_model2_depth('auc_folders');
[fof_sound,fof_choice,fof_prior, fof_prob, fof_neuron] = process_20231002_encoding_model2_depth('fof_folders');
[mpfc_sound,mpfc_choice,mpfc_prior, mpfc_prob, mpfc_neuron] = process_20231002_encoding_model2_depth('mpfc_folders');

%% fig 5d
cd('G:\upload_code\Figure6\Fig6cd');
sdata = struct();% source data 
[hist_x,hist_auc,hist_fof,hist_mpfc] = ranksum_areas(auc_sound,fof_sound,mpfc_sound);
sdata.hist_x= hist_x(2:end)';
...
writetable(T, 'source fig 6d.csv');
...
T = struct2table(sdata);
writetable(T, 'source fig 6c.csv');
