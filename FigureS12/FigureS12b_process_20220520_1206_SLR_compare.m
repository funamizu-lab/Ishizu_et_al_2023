...
----------------------------------------------------------------------------
%}
function FigureS12b_process_20220520_1206_SLR_compare
...
get_p_correct_20221206(auc_correct_p, fof_correct_p, mpfc_correct_p, prior_frame, correct_rate_y_values)

%Sound
get_p_correct_20221206(auc_correct_s, fof_correct_s, mpfc_correct_s, sound_on_frame, correct_rate_y_values)

%choice
get_p_correct_20221206(auc_correct_c, fof_correct_c, mpfc_correct_c, sound_long_off_frame, correct_rate_y_values)


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [p,median_correct] = get_p_correct_20221206(auc_correct_s, fof_correct_s, mpfc_correct_s, use_frame, y_axis_values)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
