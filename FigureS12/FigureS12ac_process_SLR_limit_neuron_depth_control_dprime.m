...
----------------------------------------------------------------------------
%}
function FigureS12ac_process_SLR_limit_neuron_depth_control_dprime(folders)
...
get_correct_prior_include3(dp_l_sound,dp_l_choice,dp_l_prior,dp_l_value,...
    use_frame, max_nan_data, [-0.5 3]);

%%% FigS12c %%% 
get_correct_plot_20221206(dp_l_sound,[-1 4]);
...
function get_correct_prior_include3(l_sound,l_choice,l_prior,l_value,...
    use_frame, max_nan_data, plot_scale)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function get_correct_plot_20221206(correct_l_sound, plot_scale)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
use_frame = 1:3;
